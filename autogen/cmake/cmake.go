...
func (cmake *CMake) checkPlatformCheckResult(item, variable string) {
...
func (cmake *CMake) RequireHeaderExists(header string) {
...
func (cmake *CMake) RequireLibraryExists(library, function string) {
